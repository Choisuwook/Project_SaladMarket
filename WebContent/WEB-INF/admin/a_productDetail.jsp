          ...
          <form name="productDetailFrm">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="typography-line">
                  <h4><span>상품패키지명</span>${pvo.fk_pacname}</h4>          
	            </div>
                <div class="typography-line">
                  <h4>
                    <span>대분류</span>${pvo.fk_sdname}</h4>
                </div>
                <div class="typography-line">
                  <h4>
               ...
               <div class="typography-line">
                  <h4>
                    <span>카테고리태그</span></h4>${pvo.fk_ctname}
                </div>
                <div class="typography-line">
                  <h4>
                ...
                <div class="typography-line">
                  <h4>
                    <span>원가</span>${pvo.price}</h4>
                </div>
                <div class="typography-line">
                  <h4>
                    <span>판매가</span>${pvo.saleprice}</h4>
                </div>
                <div class="typography-line">
                  <h4>
                    <span>포인트</span>${pvo.point}</h4>
                </div>
                <div class="typography-line">
                  <h4>
                    <span>재고량</span>${pvo.pqty}</h4>
                </div>
                <div class="typography-line">
                  <h4>
                ...
                <div class="typography-line">
                  <h4>
                    <span>좋아요수</span>${pvo.salecount}</h4>
                </div>
                <div class="typography-line">
                  <h4>
