   		...
   		<c:if test="${requestScope.method eq 'GET'}">        
		       <div class="form-group" style="margin-top: 3%;">
		         <div class="col-md-4" style="margin-top: 3%;"></div> <%-- 이부분은 칸 조정할려고 넣어놨어요ㅠㅠ --%>
		          ...
		          <div class="col-md-3">
		             <input type="text" id="userid" name="userid" class="form-control" value="${userid}" placeholder="ID">
		          </div>
		       </div>
			     ...
			     <c:if test="${n == 1}">
			       <div class="form-group">
			         <div class="col-md-3" style="margin-top: 3%;"></div> <%-- 이부분은 칸 조정할려고 넣어놨어요ㅠㅠ --%>
			       	 <div class="col-md-6 row" style="margin-top: 3%; text-align: center;">
			         	<h2>${requestScope.email}로 인증코드가 발송되었습니다.</h2>
			         	 <input type="hidden" id="useridConfirm" name="userid" class="form-control" value="${userid}">		         
				         <input type="text" name="input_confirmCode"  class="form-control" id="input_confirmCode" width="40%;" placeholder="인증코드를 입력하세요" required />
			   	      	 <button type="button" class="btn btn-info" id="btnConfirmCode" style="margin-top: 3%;">인증하기</button>    
			          </div> 
