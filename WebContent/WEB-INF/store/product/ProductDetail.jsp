	...
	$(document).ready(function() {
		...
		$("#option").change(function () {
			...
			var html = "<tr>"
	               ...
	               +"</tr> "             
			if(pnum != $(this).val()) $("#addList").append(html);
			else alert("해당 상품은 선택되어있습니다.");
		});
						...
						<div class="product-detail-wrap">
							<div class="row">
								<div class="col-md-5">
									...
									<!-- 상품 대표이미지 -->
										<c:if test="${packageDetail.pacnum != 1}">
										...
										<div style="margin-top:5%; border: 1px solid red">
											<div class="row" style="border: 1px solid red">
											  <div class="col-md-12" style="border: 1px solid blue">
												   ...
												   <div class="col-md-7"><fmt:formatNumber value="${indexProdcut.saleprice}" pattern="###,###"></fmt:formatNumber>원</div>
											   </div>
											   <div class="col-md-12" style="border: 1px solid blue">
