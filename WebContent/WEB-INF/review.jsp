 ...
 <!--  side info -->
 	<div class="col-md-9">
      <div id="dashboard-content">		        
		<h1 class="screen-reader-only">후기</h1>		
		  <ul class="tabs nav nav-tabs" role="tablist">
		    <li class="active">
		      <a class="tab-item" data-toggle="tab" href="#home" role="tab" aria-controls="received" aria-selected="true">
		        	나에 대한 후기
		      </a>
		    </li>
		    <li>
		      <a data-toggle="tab" href="#menu1" class="tab-item" role="tab" aria-controls="sent" aria-selected="false">
		       		 내가 작성한 후기
		      </a>
		    </li>
		  </ul>		  
		 ...
		 <h1 class="screen-reader-only">후기</h1>
			...
			<!-- 나에 대한 후기 시작 -->
			  <div class="tab-panel" role="tabpanel" aria-hidden="false" id="received">
			    <div class="panel">
			      <div class="panel-header" id="home" class="tab-pane fade in active" >
			        <h2 class="edit-profile-section-heading">지난 후기</h2>
			      </div>
			  ...
			  <div class="tab-panel" role="tabpanel" aria-hidden="true" id="sent">	
			    ...
			    <div>
			      <div class="panel-header">
			        <h2 class="edit-profile-section-heading">작성해야 할 후기 </h2>
			      </div>
			      <div id="menu1" class="panel-body panel tab-pane fade">			
			    ...
			    <div class="panel space-top-4">
			      <div class="panel-header">
			        <h2 class="edit-profile-section-heading">내가 작성한 후기</h2>
			      </div>
			      <div class="panel-body">
			        <ul class="list-layout reviews-list">
			           <li class="past-reviews-list-item">아직 후기를 남기지 않으셨습니다.</li>
			        </ul>
			      </div>
			      <!-- 내가 작성한 후기 끝-->
			    </div>			  
