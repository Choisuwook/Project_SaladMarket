...
<%-- 					     html += "<div class='col-md-3 text-center'>"+									
				...
				"</div>"; --%>
						...
						if(entry.pacname == '없음' ) {
							 html += " <div class='col-md-3 text-center' style='border:1px solid red'>"+
								"	<div class='product-entry'>"+
									"<div class='product-img'>"+
								"	<img src='<%= CtxPath %>/img/"+entry.pimgfilename+"' width='100%' height='100%' />"+
	...
	<div class="container" >
		...
		<%-- 이벤트 이름 --%>
			...
			<div class="row" >
				...
				<div class="row row-pb-lg" id="displayResultEvent" style="border:1px solid red;">
				</div>
				</div>
					<%--  이미지 하단 태그 끝 --%>			
			</div>
