...
public class GoogleMail {
    ...
    public void sendmail(String recipient, String certificationCode)  
    	...
    	prop.put("mail.smtp.user", "fine2656@gmail.com");
    	...
    	// 보내는 사람의 메일주소
    	String sender = "fine2656@gmail.com";
    ...
    public void sendmail_OrderFinish(String recipient, String name, String emailContents)  
    		throws Exception{
    	...
    	// 제목 설정
    	String subject = "localhost:9090/MyMVC/mallHome.do "+name+"회원님의 주문이 성공했습니다. ";
    	msg.setSubject(subject);
    ...
    public void sendmail_DeliverStartFinish(String name,String recipient,String emailContents) throws Exception{
