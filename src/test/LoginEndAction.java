...
/*
			...
			if(!"POST".equalsIgnoreCase(method)) {//post방식으로 넘어온 것이 아니라면
				...
				checkbox 에 value 값을 안주었을 시 체크를 한것 이라면
				==>확인용 (saveid):ON
				
				checkbox 에 value 값을 안주었을 시 언체크를 한것 이라면
				==>uncheck 시 ==> 확인용 (saveid):null
