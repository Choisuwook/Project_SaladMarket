...
<<<<<<< HEAD
				String sql = "\n"+
						...
						"        , pcompanyname, pexpiredate, allergy, weight, salecount, plike, pdate,pimgfilename\n"+
						"from\n"+
						"(\n"+
				...
				while(rs.next()) {
					...
					if(pacname == "없음") {
						...
						pacimage = rs.getString("pacimage");
						v_etname = rs.getString("etname");
						pname = rs.getString("pname");
						pimgfilename = rs.getString("pimgfilename");
						 pacnum = rs.getInt("pacnum");
					}
					else {
						stname = rs.getString("stname");
						saleprice =  rs.getInt("saleprice");
